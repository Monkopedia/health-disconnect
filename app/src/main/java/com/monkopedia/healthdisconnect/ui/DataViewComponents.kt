...
internal fun unitSuffix(unit: String?): String {
...
internal fun recordDetailsText(record: Record): String {
...
internal fun recordTimestampLabel(record: Record): String? {
...
internal fun recordPrimaryValueLabel(record: Record): String? {
    val ignored = setOf(
        "getClass",
        "getMetadata",
        "getZoneOffset",
...
internal data class ParsedMeasurementText(val value: Double, val unit: String?)

internal fun parseMeasurementFromText(text: String): ParsedMeasurementText? {
